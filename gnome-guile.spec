...
%description -l pl 
Interpreter guile dla GNOME. Wiele jego narzЙdzi wykorzystuje ten
pakiet.

%package devel
Summary:	GNOME guile includes
Summary(pl):	Pliki nagЁСwkowe dla GNOME guile
...
Pliki nagЁСwkowe do programowania z u©yciem GNOME guile.
